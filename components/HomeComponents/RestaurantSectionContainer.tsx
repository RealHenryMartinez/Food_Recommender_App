...
import { getTotalCategories, getTotalRestaurants } from "../../store/HomePageSlices/useBusinessSlice";
import RemainingRestaurants from "./RemainingRestaurants";
import { ListRenderItemInfo, VirtualizedList } from "react-native";
import { ICategory, ICategoryDetails } from "../../interfaces/restaurantInterface";
      ...
      <>
        <ContentListContainer>
          <SectionList
            ListHeaderComponent={
              <>
                <HeaderContainer>
                  ...
                  <BackgroundHeaderImage source={HeaderBackground} />
                  <HeaderContent>
                    {/* Display search bar */}
                    <SearchBar />
                  </HeaderContent>
            ...
            renderItem={({ item }: ListRenderItemInfo<ICategoryDetails>) => (
              <>
